...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'unifunc' => 'content_57a3c569c0ede8_46327481',
  'has_nocache_code' => true,
  'cache_lifetime' => 31536000,
),true); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_57a3c569c0ede8_46327481')) {function content_57a3c569c0ede8_46327481($_smarty_tpl) {?>
	<!-- Block CMS module -->
			<section id="informations_block_left_1" class="block informations_block_left">
			<p class="title_block">
				<a href="http://localhost:8080/prestashop/content/category/1-inicio">
					Información				</a>
			</p>
			<div class="block_content list-block">
				<ul>
																							<li>
								<a href="http://localhost:8080/prestashop/content/1-entrega" title="Envío">
									Envío
								</a>
							</li>
																								<li>
								<a href="http://localhost:8080/prestashop/content/2-aviso-legal" title="Aviso legal">
									Aviso legal
								</a>
							</li>
																								<li>
								...
								<a href="http://localhost:8080/prestashop/content/4-sobre-nosotros" title="Sobre nosotros">
									Sobre nosotros
																								...
																								<li>
								<a href="http://localhost:8080/prestashop/content/5-pago-seguro" title="Pago seguro">
									Pago seguro
								</a>
							</li>
																						<li>
